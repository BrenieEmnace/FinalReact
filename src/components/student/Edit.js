    ...
    <Grid item md={6} xs={12}>
     ...
     <form>
      <Grid container spacing={2}>
       ...
       <Grid item xs={12} sm={6}>
        <TextField autoComplete="stuaddress" name="stuaddress" variant="outlined" required fullWidth id="stuaddress" label="Address" value={student.stuaddress} onChange={e => onTextFieldChange(e)} />
       </Grid>
       <Grid item xs={12} sm={6}>
        <TextField autoComplete="stunumber" type="number" name="stunumber" variant="outlined" required fullWidth id="stunumber" label="Contact Number" value={student.stunumber} onChange={e => onTextFieldChange(e)} />
       </Grid>
       <Grid item xs={12}>
